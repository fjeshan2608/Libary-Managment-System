                    ...
                    <div class="row">
                            ...
                            <div class="card card-plain mt-8">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <label>Email</label>
                                        <div class="mb-3">
                                            <input id="email" class="form-control" type="email" placeholder="E-mail" name="email" :value="old('email')" required autofocus autocomplete="username">
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                                <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6" style="background-image:url('storage/backend/assets/img/curved-images/curved6.jpg')">
                                </div>
                            </div>
                        </div>
                    </div>
